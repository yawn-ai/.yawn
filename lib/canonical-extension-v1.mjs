...
export const INVALID_YAWN_SCHEMA_ALIASES = Object.freeze([".ion", ".yon", ".ywn"]);
...
const replacementRules = Object.freeze([
  ...
  { id: "dotted-extension", pattern: /\.(?:ion|yon|ywn)\b/giu, replacement: CANONICAL_YAWN_EXTENSION },
  { id: "spoken-dot-extension", pattern: /\bdot\s+(?:ion|yon|ywn)\b/giu, replacement: CANONICAL_YAWN_EXTENSION },
  {
    id: "schema-noun-extension",
    pattern: /\b(?:ion|yon|ywn)(?=\s+(?:file|files|schema|schemas|record|records|format|formats|extension|extensions)\b)/giu,
