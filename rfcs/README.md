...
- [RFC 0004: The slash carries capabilities — slash commands as invocations inside a relation step](0004-slash-command-as-capability-invocation.md) — proposed / owner review required
